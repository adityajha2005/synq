...
export function SDKSection({
      ...
      <div className="space-y-1">
        <div className="flex">
          ...
          <code className="flex-1 text-[#abb2bf]">
            <span className="text-[#c678dd]">npm</span> install <span className="text-[#e06c75]">avalanche-commerce-sdk</span>
          </code>
        </div>
        <div className="flex">
        ...
        <div className="flex">
          ...
          <code className="flex-1 text-[#abb2bf]">
            <span className="text-[#c678dd]">import</span> {'{'} <span className="text-[#e5c07b]">CheckoutButton</span> {'}'} <span className="text-[#c678dd]">from</span> <span className="text-[#98c379]">"avalanche-commerce-sdk"</span>;
          </code>
        </div>
        <div className="flex">
  ...
  const codeToCopy = `npm install avalanche-commerce-sdk
